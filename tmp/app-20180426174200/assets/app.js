...
client.invoke('resize', { width: '104%', min-height: '275px' });
...
var requests = {
  ...
  getCSV: function(filename) {
    return {
      url: 'https://docs.google.com/spreadsheets/d/' + filename + '/export?format=csv',
      type: 'GET',
      cors: false,
      dataType: 'text',
    };
...
function getCSVFile() {
  ...
  this.counter = 0;
  this.$('div.progress > div.progress-bar').css({ "width": "2%" });
